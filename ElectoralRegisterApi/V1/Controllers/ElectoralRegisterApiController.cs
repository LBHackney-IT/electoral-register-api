...
namespace ElectoralRegisterApi.V1.Controllers
{
    [ApiController]
    ...
    public class ElectoralRegisterApiController : BaseController
    {
        private readonly IGetAllUseCase _getAllUseCase;
        private readonly IGetByIdUseCase _getByIdUseCase;
        public ElectoralRegisterApiController(IGetAllUseCase getAllUseCase, IGetByIdUseCase getByIdUseCase)
        {
