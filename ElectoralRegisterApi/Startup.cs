...
namespace ElectoralRegisterApi
{
    public class Startup
    {
        ...
        private const string ApiName = "Electoral Register API";
        ...
        public static void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseXRay("electoral-register-api");
